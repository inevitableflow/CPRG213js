...
function recalculate() {
    let cost = document.getElementById('calculatedCost');

    if (modelName === 'XYZ') {
        cost.textContent = duration * 100;

    } else if (modelName === 'CPRG') {
        cost.textContent = duration * 213;
    }
}
...
function changeDuration() {
    ...
    if (isNaN(duration)) {
        ...
        document.getElementById('durationText').innerHTML = duration;
        recalculate();
    }
}
